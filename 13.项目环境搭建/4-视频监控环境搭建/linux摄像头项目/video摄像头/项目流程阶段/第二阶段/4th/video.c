...
void show_pixel(unsigned char *fbmem,unsigned char *color)
{
	
	unsigned short *src = (unsigned short *)fbmem;
...
/*********************************************************************/	
	...
	ptVideoBufIn.iBpp = (tV4l2Fmt.fmt.pix.pixelformat == V4L2_PIX_FMT_YUYV) ? 32 : \
