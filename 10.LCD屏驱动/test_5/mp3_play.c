...
void  Auto_play(song *head)
{
	...
	while(song_tmp)
	{
		...
		else if(pid == 0)	//孙子进程
		{
			...
			GUI_RectangleFill(100,100,280,116,BLUE,BLUE);
			Show_str(100,100,BLUE,BLACK,song_tmp->name,16,16);
			execlp("madplay","madplay","-a-30",my_song,NULL);
		}
		else	//子进程
		{
			//内存映射
