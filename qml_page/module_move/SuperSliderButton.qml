...
Button {
    ...
    background: Rectangle {
        color: "transparent"
        anchors.fill: root
        anchors.margins: root.pressed | root.pressAndHold | !root.enabled ? 3 : 1
        ...
        DropShadow {
            ...
            horizontalOffset: root.pressed | root.pressAndHold
                              | !root.enabled ? 0 : dropShadowOffset * 2
            Behavior on horizontalOffset {
                NumberAnimation {
                    duration: 75
                }
            }
            verticalOffset: root.pressed | root.pressAndHold | !root.enabled ? 0 : dropShadowOffset
