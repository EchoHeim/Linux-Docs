    ...
    background: Rectangle {
        ...
        Item {
            ...
            anchors.bottomMargin: textArea.opacity
                                  === 0 ? (root.pressed | root.pressAndHold ? 4 : 2) : parent.height
                                          / 5 + (root.pressed | root.pressAndHold ? 4 : 2)
            anchors.topMargin: root.pressed | root.pressAndHold ? 4 : 2
            anchors.leftMargin: root.pressed | root.pressAndHold ? 4 : 2
            anchors.rightMargin: root.pressed | root.pressAndHold ? 4 : 2
            //            DropShadow {
