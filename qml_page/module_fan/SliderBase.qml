...
Slider {
    ...
    property var dispValue: (value / to * 100).toFixed(0)
    property var percentValue: (value / to * 100).toFixed(10)
    ...
    handle: Rectangle {
        ...
        Label {
            text: root.dispValue + root.unit
            anchors.bottom: parent.top
            anchors.horizontalCenter: parent.horizontalCenter
            font.pixelSize: root.availableHeight / 4
